...
describe('graph service', () => {
  ...
  function seedChain(): void {
    ...
    db.upsertRelations('B', [
      { sourceId: 'B', targetId: 'C', type: 'related-to' },
    ])
    db.upsertRelations('C', [
      { sourceId: 'C', targetId: 'D', type: 'related-to' },
    ])
  }
  ...
  describe('getDirectRelations', () => {
    it('returns both outgoing and incoming relations', () => {
      ...
      db.upsertRelations('X', [
        { sourceId: 'X', targetId: 'Y', type: 'related-to' },
      ])
      db.upsertRelations('Z', [
        { sourceId: 'Z', targetId: 'Y', type: 'informs' },
      ])
    ...
    it('returns each relation with source/target IDs and type', () => {
      ...
      db.upsertRelations('P', [
        { sourceId: 'P', targetId: 'Q', type: 'supersedes' },
      ])
  ...
  describe('traverseGraph', () => {
    ...
    it('handles cycles without infinite loop', () => {
      ...
      db.upsertRelations('cyc-A', [
        { sourceId: 'cyc-A', targetId: 'cyc-B', type: 'related-to' },
      ])
      db.upsertRelations('cyc-B', [
        { sourceId: 'cyc-B', targetId: 'cyc-A', type: 'related-to' },
      ])
    ...
    it('caps depth at 3 even if higher is requested', () => {
      ...
      db.upsertRelations('D', [
        { sourceId: 'D', targetId: 'E', type: 'related-to' },
      ])
  ...
  describe('mixed relation types', () => {
    it('traverses related-to bidirectionally', () => {
      ...
      db.upsertRelations('bi-A', [
        { sourceId: 'bi-A', targetId: 'bi-B', type: 'related-to' },
      ])
    ...
    it('traverses supersedes only forward (source to target)', () => {
      ...
      db.upsertRelations('new', [
        { sourceId: 'new', targetId: 'old', type: 'supersedes' },
      ])
    ...
    it('traverses parent only forward (child to parent)', () => {
      ...
      db.upsertRelations('child', [
        { sourceId: 'child', targetId: 'par', type: 'parent' },
      ])
