...
export const KNOWN_COMMANDS = [
  'task', 'workstream', 'project', 'waves', 'next', 'dispatch',
  'briefing', 'context', 'verify', 'audit', 'check', 'onboard',
  'relate', 'activity', 'import', 'capture', 'setup', 'decision',
  'prompt', 'show', 'claim', 'orchestrate', 'list',
];

export const WRITE_OPERATIONS = new Set([
  'add', 'update', 'delete', 'claim', 'complete', 'block', 'done', 'cancel',
  'start', 'release', 'unblock', 'init', 'onboard', 'import', 'relate',
]);
