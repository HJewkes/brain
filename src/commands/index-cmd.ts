...
function frontmatterToRecord(
  ...
  return {
    ...
    tags: fm.tags ? (Array.isArray(fm.tags) ? fm.tags.join(',') : String(fm.tags)) : null,
    ...
    modifiedAt: fm.modified ? String(fm.modified) : null,
    lastReviewed: fm['last-reviewed'] ? String(fm['last-reviewed']) : null,
